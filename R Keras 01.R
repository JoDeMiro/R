...
library(keras)
#The R interface to Keras uses TensorFlow as it’s
#underlying #computation engine.So we need to install Tensorflow engine
...
if(!data_augmentation) {  
  ...
  model %>% fit_generator(
    flow_images_from_data(train_x, train_y,gen_images,
                          batch_size=32,save_to_dir="C:/CNNcifarimages/"),
